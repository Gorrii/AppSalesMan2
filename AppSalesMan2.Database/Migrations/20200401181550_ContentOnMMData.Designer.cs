...
namespace AppSalesMan2.Database.Migrations
{
    ...
    [Migration("20200401181550_ContentOnMMData")]
    partial class ContentOnMMData
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppSalesMan2.Database.Entity.ContentOnMMData", b =>
                {
                    ...
                    b.Property<string>("CriticalIssue")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AppSalesMan2.Database.Entity.IndirectData", b =>
                {
                    b.Property<int>("IndirectID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("DystrCustomer")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AppSalesMan2.Database.Entity.WonOppData", b =>
                {
                    b.Property<int>("WonOppId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("EstimatedOIDate")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("SalesManId")
                        .HasColumnType("int");

                    b.Property<string>("WonOppEndCustomer")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("WonOppName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double>("WonOppVolumen")
                        .HasColumnType("float");

                    b.HasKey("WonOppId");

                    b.ToTable("WonOppDatas");
                });
